...
public class Lua_CustomLabel : LuaObject {
	...
	static public int UpdateMyNGUIText(IntPtr l) {
		try {
			CustomLabel self=(CustomLabel)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(CustomLabel),typeof(UIWidget));
	}
}
