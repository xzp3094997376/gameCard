...
public class UILabelInspector : UIWidgetInspector
{
    ...
    SL_FontSize mfs = SL_FontSize.EDefalut;
    SL_FontColor mfc = SL_FontColor.EDefalut;
    private int _selectIndex = (int)SL_FontColor.EDefalut;
    // ====
    ...
    private void drawCostomLabel() 
    {
        // dxj 
        GUILayout.BeginHorizontal();
        EditorGUILayout.LabelField("闪乱颜色类型", GUILayout.Width(80));
        SL_FontColor fc = mfc;
        fc = (SL_FontColor)EditorGUILayout.EnumPopup(mfc, "DropDown", GUILayout.Width(74f));
        //首先获取枚举中的所有名字数组，通过 Popup将数组显示为下拉框，返回选中的项
        GUILayout.Space(10);
        if (fc != mfc)
        {
            mfc = fc;
            mLabel.effectStyle = UILabel.Effect.Outline8;
            switch (mfc)
            {
                case SL_FontColor.EButton_normal:
                    mLabel.color = Color.white;
                    mLabel.effectColor = new Color(145f / 255f, 61f / 255f, 0f);
                    break;
                case SL_FontColor.EButton_enable:
                    mLabel.color = Color.white;
                    mLabel.effectColor = new Color(110f / 255f, 110f / 255f, 110f / 255f);
                    break;
                case SL_FontColor.EButton_cannel:
                    mLabel.color = Color.white;
                    mLabel.effectColor = new Color(0f / 255f, 59f / 255f, 135f / 255f);
                    break;
                case SL_FontColor.EDesc:
                    mLabel.color = new Color(59f / 255f, 28f / 255f, 10f / 255f);
                    mLabel.effectStyle = UILabel.Effect.None;
                    break;
                case SL_FontColor.EProperty:
                    mLabel.color = new Color(255f / 255f, 255f / 255f, 150f / 255f);
                    mLabel.effectColor = Color.black;
                    break;
                case SL_FontColor.ETabFocus:
                    mLabel.color = new Color(112f / 255f, 34f / 255f, 0f);
                    mLabel.effectColor = new Color(255f / 255f, 235f / 255f, 173f / 255f);
                    break;
                case SL_FontColor.ETabNoFocus:
                    mLabel.color = new Color(100f / 255f, 100f / 255f, 100f / 255f);
                    mLabel.effectColor = Color.white;
                    break;
                case SL_FontColor.ETitle:
                    mLabel.color = Color.white;
                    mLabel.effectColor = Color.black;
                    break;
                default:
        ...
        EditorGUILayout.LabelField("闪乱大小类型", GUILayout.Width(80));
        SL_FontSize fs = mfs;
        fs = (SL_FontSize)EditorGUILayout.EnumPopup(mfs, "DropDown", GUILayout.Width(74f));
        //首先获取枚举中的所有名字数组，通过 Popup将数组显示为下拉框，返回选中的项
        if (fs != mfs)
        {
            mfs = fs;
            switch (mfs)
            {
                case SL_FontSize.EButton2:
                    mLabel.fontSize = 36;
                    break;
                case SL_FontSize.EButton4:
                    mLabel.fontSize = 30;
                    break;
                case SL_FontSize.EDESC:
                    mLabel.fontSize = 18;
                    break;
                case SL_FontSize.EProperty:
                    mLabel.fontSize = 22;
                    break;
                case SL_FontSize.ETitle2:
                    mLabel.fontSize = 30;
                    break;
                case SL_FontSize.ETitle4:
                    mLabel.fontSize = 26;
                    break;
                default:
                    mLabel.fontSize = 22;
