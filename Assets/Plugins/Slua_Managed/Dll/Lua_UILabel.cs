...
public class Lua_UILabel : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_overflowEllipsis(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.overflowEllipsis);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_overflowEllipsis(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			bool v;
			checkType(l,2,out v);
			self.overflowEllipsis=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"overflowEllipsis",get_overflowEllipsis,set_overflowEllipsis,true);
