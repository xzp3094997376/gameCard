...
public class Lua_NGUITools : LuaObject {
	...
	static public int AddSprite_s(IntPtr l) {
		try {
			...
			var ret=NGUITools.AddSprite(a1,a2,a3,a4);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int DestroyChildren_s(IntPtr l) {
		try {
			UnityEngine.Transform a1;
			checkType(l,1,out a1);
			NGUITools.DestroyChildren(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int KeyToCaption_s(IntPtr l) {
		try {
			UnityEngine.KeyCode a1;
			checkEnum(l,1,out a1);
			var ret=NGUITools.KeyToCaption(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,KeyToCaption_s);
		addMember(l,"keys",get_keys,set_keys,false);
