...
public class Lua_NGUIText : LuaObject {
	...
	static public int GetSymbol_s(IntPtr l) {
		try {
			...
			var ret=NGUIText.GetSymbol(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int GetGlyphWidth_s(IntPtr l) {
		try {
			...
			System.Int32 a2;
			checkType(l,2,out a2);
			var ret=NGUIText.GetGlyphWidth(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int GetGlyph_s(IntPtr l) {
		try {
			...
			System.Int32 a2;
			checkType(l,2,out a2);
			var ret=NGUIText.GetGlyph(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int ParseAlpha_s(IntPtr l) {
		try {
			...
			System.Int32 a2;
			checkType(l,2,out a2);
			var ret=NGUIText.ParseAlpha(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int ParseColor24_s(IntPtr l) {
		try {
			...
			System.Int32 a2;
			checkType(l,2,out a2);
			var ret=NGUIText.ParseColor24(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int ParseColor32_s(IntPtr l) {
		try {
			...
			System.Int32 a2;
			checkType(l,2,out a2);
			var ret=NGUIText.ParseColor32(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int EncodeAlpha_s(IntPtr l) {
		try {
			System.Single a1;
			checkType(l,1,out a1);
			var ret=NGUIText.EncodeAlpha(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int EncodeColor24_s(IntPtr l) {
		try {
			UnityEngine.Color a1;
			checkType(l,1,out a1);
			var ret=NGUIText.EncodeColor24(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int EncodeColor32_s(IntPtr l) {
		try {
			UnityEngine.Color a1;
			checkType(l,1,out a1);
			var ret=NGUIText.EncodeColor32(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int GetExactCharacterIndex_s(IntPtr l) {
		try {
			...
			checkType(l,3,out a3);
			var ret=NGUIText.GetExactCharacterIndex(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int GetApproximateCharacterIndex_s(IntPtr l) {
		try {
			...
			UnityEngine.Vector2 a3;
			checkType(l,3,out a3);
			var ret=NGUIText.GetApproximateCharacterIndex(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(NGUIText));
	}
}
