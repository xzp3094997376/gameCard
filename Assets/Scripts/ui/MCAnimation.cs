...
[RequireComponent(typeof(MCSprite))]
public class MCAnimation : MonoBehaviour
{
    ...
    void UpdateSprite()
    {
        ...
        if (mUnitySprite != null)
        {
            ...
            if (offsets[mIndex] != null)
            {
                mUnitySprite.transform.localPosition = Vector2.zero;
            }
        }
        else if (mNguiSprite != null)
        {
            ...
            if (offsets[mIndex] != null)
            {
                mNguiSprite.transform.localPosition = Vector2.zero;
            }
        }
    }
}