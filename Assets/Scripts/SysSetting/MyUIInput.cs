...
public class MyUIInput :MonoBehaviour
{
	...
	static public MyUIInput current;

	/// <summary>
	/// Currently selected input field, if any.
	/// </summary>

	static public MyUIInput selection;
	...
	protected void Init ()
	{
		if (mDoInit && label != null)
		{
			...
			if (label.alignment == NGUIText.Alignment.Justified)
			{
				...
				MyDebug.LogWarning("Input fields using labels with justified alignment are not supported at this time", this);
			}
