...
public class CustomLabel : UIWidget
{
    ...
    public string text
    {
        ...
        set
        {
            ...
            {
                mText = value;
                Debug.Log("CustomLabel mText == " + mText);
                Reset();
                ParserSymbol(mText);
    ...
    override protected void Awake()
    {
        ...
        facePrefab = ClientTool.Pureload("Prefabs/moduleFabs/chatModule/ChatFace1");
        AssetBundles.AssetBundleLoader.Retain("Prefabs/moduleFabs/chatModule/ChatLabel".ToLower());
        AssetBundles.AssetBundleLoader.Retain("Prefabs/moduleFabs/chatModule/ChatFace1".ToLower());
    ...
    void OnDestroy()
    {
        ...
        AssetBundles.AssetBundleLoader.Release("Prefabs/moduleFabs/chatModule/ChatFace1".ToLower());
    }
    //	void Start(){
    ...
    private void CreateTextLabel(string value)
    {
        ...
        Debug.Log("CreateTextLabel text == " + text);
        label.text = text;
        Debug.Log("CreateTextLabel label.text == " + label.text);
    ...
    {
        Debug.Log("SingleLineWrapText text == " + text);
        myHeight = 0;
